...
if TYPE_CHECKING:
    ...
    SENDNN_INFERENCE_MM_DTYPE: str = "float16"
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Specifies the dtype to use for multimodal components (vision_tower, multi_modal_projector)
    # when running vision models. Defaults to "float16". Set to "bfloat16" for Power or
    # "float32" for Z to use a different dtype than the language model.
    # Only applicable when SENDNN_INFERENCE_DYNAMO_BACKEND is set to "sendnn".
    "SENDNN_INFERENCE_MM_DTYPE": lambda: os.getenv("SENDNN_INFERENCE_MM_DTYPE", "float16"),
}
